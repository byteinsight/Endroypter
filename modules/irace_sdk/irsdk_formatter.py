...
class Formatter:
    ...
    def make_daytime_string(time_in_seconds):
        """
        Convert a seconds value (float/int or numeric string) into H:MM:SS.
        ...
        try:
            ...
            # Non-numeric or incorrect input
            return "00:00:00"
    ...
    # -------------------------------------------------------
    # Weather & Ephemeral Formatting
    # -------------------------------------------------------
    @staticmethod
    def get_temp_str(air_temp):
        """
        ...
        :return:
        """
        return f"{air_temp:.2f}"

    @staticmethod
    def convert_air_density(air_density):
        """
        Density of air at start/finish line (kg/m^3)
        :param air_density:
        :return:
        """
        return f"{air_density:.2f}"
