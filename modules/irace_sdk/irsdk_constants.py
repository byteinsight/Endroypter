...
class IrConstants:
    ...
    # -------------------------------------------------------
    # PIT STOP Statuses and Servicing Flags
    # -------------------------------------------------------
    PIT_SV_IN_PROGRESS = 1
    PIT_SV_COMPLETE = 2
    PIT_SV = {0, PIT_SV_IN_PROGRESS, PIT_SV_COMPLETE}
    ...
    FUEL_FLAG = 0x10
    TYRE_BITS = [0x01, 0x02, 0x04, 0x08]  # lf, rf, lr, rr
    TYRE_TO_NAME = {0x01: "LF", 0x02: "RF", 0x04: "LR", 0x08: "RR"}
    ...
    IN_PIT_BOX = 1
    ON_PIT_LANE = 2
    PIT_AREA_SURFACES = {IN_PIT_BOX, ON_PIT_LANE}
